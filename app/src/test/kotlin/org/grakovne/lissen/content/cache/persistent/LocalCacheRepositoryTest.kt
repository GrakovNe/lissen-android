...
class LocalCacheRepositoryTest {
  ...
  private val offlinePlaybackSessionRepository = mockk<OfflinePlaybackSessionRepository>(relaxed = true)
  ...
  fun setUp() {
    repository =
      LocalCacheRepository(
        ...
        offlinePlaybackSessionRepository = offlinePlaybackSessionRepository,
      )
  }
