...
internal object DynamicsProcessingTuning {
  ...
  // Fixed 5-band pre-EQ set matching the AOSP default. DynamicsProcessing.EqBand takes each
  // band's upper cutoff frequency, not its centre, so the centres below map to the cutoffs
  // above; the UI keeps showing the centres.
